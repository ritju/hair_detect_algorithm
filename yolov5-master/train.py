...
Usage:
    $ python path/to/train.py --data VOC.yaml --weights yolov5m.pt --img 640
"""
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = data.endswith('VOC.yaml') and nc == 80  # COCO dataset
...
def parse_opt(known=False):
    ...
    parser.add_argument('--batch-size', type=int, default=16, help='tot+al batch size for all GPUs')
    ...
    parser.add_argument('--evolve', type=int, nargs='?', default=False, const=300, help='evolve hyperparameters for x generations')
